...
export class WebsocketProvider extends ObservableV2<{
    ...
    closed: (event: {
        code: number;
        reason: string;
    }, provider: WebsocketProvider) => any;
    status: (event: {
     ...
     */
    constructor(serverUrl: string, roomname: string, doc: Y.Doc, { connect, awareness, params, protocols, WebSocketPolyfill, resyncInterval, maxBackoffTime, disableBc, shouldReconnect }?: {
        ...
        shouldReconnect?: ((event: CloseEvent, provider: WebsocketProvider) => boolean) | undefined;
    });
    serverUrl: string;
    bcChannel: string;
     ...
     */
    shouldReconnect: (event: CloseEvent, provider: WebsocketProvider) => boolean;
    /**
