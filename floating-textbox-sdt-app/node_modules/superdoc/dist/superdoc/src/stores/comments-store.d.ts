export const useCommentsStore: import('pinia').StoreDefinition<"comments", Pick<{
    ...
    dropCommentsFromMutationImpact: ({ superdoc, documentId, removedIds }?: {}) => {
        ok: boolean;
