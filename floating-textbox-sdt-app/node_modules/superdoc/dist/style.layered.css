@import "@superdoc/docx-engine/style.css" layer(superdoc);
@layer superdoc{:root {
  ...
  /* Styles: tracked table-structure changes (whole-table / table-row
     ...
     they are not part of trackChanges.semanticColors. Override these
...
/* Transient UI paint takes precedence over a run's saved highlight color. */
.superdoc .sd-content-control-highlight {
  background-color: var(--sd-content-controls-highlight-bg, #ffff00) !important;
}
...
.comment-header[data-v-f2f11c96] {
  display: flex;
  align-items: center;
  justify-content: space-between;
  margin-bottom: 6px;
}
.comment-header-left[data-v-f2f11c96] {
  display: flex;
  align-items: center;
  gap: 8px;
}
.user-info[data-v-f2f11c96] {
  display: flex;
  flex-direction: column;
}
.user-name[data-v-f2f11c96] {
...
.overflow-menu.is-visible[data-v-f2f11c96] {
  opacity: 1;
  pointer-events: auto;
}
.overflow-menu__icon[data-v-f2f11c96] {
  display: flex;
...
.overflow-menu__icon[data-v-f2f11c96]:hover {
  background-color: var(--sd-ui-comments-separator, #dbdbdb);
}
.overflow-menu__icon.sd-is-disabled[data-v-f2f11c96] {
  opacity: 0.4;
  cursor: not-allowed;
  pointer-events: auto;
}
.overflow-menu__icon.sd-is-disabled[data-v-f2f11c96]:hover {
  background-color: transparent;
}
.overflow-menu__icon[data-v-f2f11c96] svg {
  width: 100%;
  height: 100%;
  display: block;
  fill: currentColor;
}
.overflow-icon[data-v-f2f11c96] {
  display: inline-flex;
  justify-content: center;
  align-items: center;
  flex-shrink: 0;
...
.comments-dialog[data-v-03d9f711] {
  display: flex;
  flex-direction: column;
...
.comments-dialog[data-v-03d9f711]:not(.is-active) {
  cursor: pointer;
}
.comments-dialog[data-v-03d9f711]:not(.is-active):not(.is-resolved):hover {
  background-color: var(--sd-ui-comments-card-hover-bg, #f3f6fd);
}
.comments-dialog[data-v-03d9f711]:not(.is-resolved):hover .overflow-menu {
  opacity: 1;
  pointer-events: auto;
}
.comments-dialog.is-active[data-v-03d9f711] {
...
.change-type[data-v-03d9f711] {
  color: var(--sd-ui-comments-body-text, #212121);
}
.tracked-change-text[data-v-03d9f711] {
  color: var(--sd-ui-comments-body-text, #212121);
}
.tracked-change-text.is-deleted[data-v-03d9f711] {
...
.tracked-change[data-track-change-semantic-color-key='move-from'] .tracked-change-text.is-deleted[data-v-03d9f711] {
  color: var(--sd-ui-comments-move-from-text, #00853d);
}
.tracked-change[data-track-change-semantic-color-key='move-to'] .tracked-change-text.is-inserted[data-v-03d9f711] {
  color: var(--sd-ui-comments-move-to-text, #00853d);
}
.tracked-change-detail-lines[data-v-03d9f711] {
  margin-top: 4px;
}
.tracked-change-detail-line[data-v-03d9f711] {
  font-size: 12px;
  line-height: 1.4;
}
.tracked-change-image-preview[data-v-03d9f711] {
  display: inline-flex;
  align-items: center;
  justify-content: center;
  margin-top: 6px;
...
.tracked-change-image-preview__image[data-v-03d9f711] {
  display: block;
  width: auto;
  height: auto;
  max-width: 90px;
...
.tracked-change-decision-alert[data-v-03d9f711] {
  display: flex;
  align-items: center;
  justify-content: space-between;
  gap: 8px;
...
.tracked-change-decision-alert__retry[data-v-03d9f711] {
  flex-shrink: 0;
}

/* ── Resolved badge ── */
.resolved-badge[data-v-03d9f711] {
  display: inline-flex;
  align-items: center;
  gap: 4px;
  font-size: 11px;
...
.resolved-badge__icon[data-v-03d9f711] {
  display: inline-flex;
  width: 12px;
  height: 12px;
}
.resolved-badge__icon[data-v-03d9f711] svg {
  width: 100%;
  height: 100%;
  fill: currentColor;
}
...
/* ── Text truncation ── */
.comment.is-truncated[data-v-03d9f711],
...
.comment.is-scrollable[data-v-03d9f711],
.tracked-change.is-scrollable[data-v-03d9f711] {
  max-height: 220px;
  overflow-y: auto;
  padding-right: 4px;
}
.show-more-toggle[data-v-03d9f711] {
  font-size: 12px;
...
.show-more-toggle[data-v-03d9f711]:hover {
  text-decoration: underline;
}

/* ── Thread collapse ── */
.collapsed-replies[data-v-03d9f711] {
  display: flex;
  align-items: center;
  gap: 6px;
  padding: 8px 0;
...
.collapsed-replies[data-v-03d9f711]:hover {
  text-decoration: underline;
}
.collapsed-avatars[data-v-03d9f711] {
  display: flex;
}
.collapsed-avatars .mini-avatar[data-v-03d9f711] {
  --sd-comment-avatar-size: 20px;
  --sd-comment-avatar-font-size: 8px;
  margin-left: -4px;
  border: 2px solid var(--sd-ui-comments-card-active-bg, #ffffff);
}
.collapsed-avatars .mini-avatar[data-v-03d9f711]:first-child {
  margin-left: 0;
}
...
.new-comment-input-wrapper[data-v-03d9f711]:focus-within {
  border-color: var(--sd-ui-comments-input-focus-border, #4f7cff);
  box-shadow: 0 0 0 2px rgba(79, 124, 255, 0.16);
}
.new-comment-input-wrapper[data-v-03d9f711] .comment-entry {
  border-radius: 0;
}
.new-comment-input-wrapper[data-v-03d9f711] .input-section {
  margin: 0;
}
.new-comment-input-wrapper[data-v-03d9f711] .superdoc-field {
  font-size: 14px;
  line-height: 20px;
  border: none;
  padding: 4px 0;
...
.new-comment-input-wrapper[data-v-03d9f711] .superdoc-field:focus,
.new-comment-input-wrapper[data-v-03d9f711] .superdoc-field:active {
  border: none;
  box-shadow: none;
  outline: none;
}
.new-comment-input-wrapper[data-v-03d9f711] .sd-editor-placeholder::before {
  content: 'Comment or add others with @';
}

/* ── Reply pill & expanded input ── */
.reply-pill[data-v-03d9f711] {
  width: 100%;
  padding: 8.5px 10.5px;
...
.reply-pill[data-v-03d9f711]:hover {
  background: var(--sd-color-gray-200, #f2f2f2);
}
.reply-pill[data-v-03d9f711]:disabled {
  cursor: not-allowed;
}
.reply-expanded[data-v-03d9f711] {
  margin-top: 10px;
}
...
.reply-input-wrapper[data-v-03d9f711]:focus-within {
  border-color: var(--sd-ui-comments-input-focus-border, #4f7cff);
  box-shadow: 0 0 0 2px rgba(79, 124, 255, 0.16);
}
.reply-input-wrapper[data-v-03d9f711] .comment-entry {
  border-radius: 0;
}
.reply-input-wrapper[data-v-03d9f711] .input-section {
  margin: 0;
}
.reply-input-wrapper[data-v-03d9f711] .superdoc-field {
  font-size: 14px;
  line-height: 20px;
  border: none;
  padding: 4px 0;
...
.reply-input-wrapper[data-v-03d9f711] .superdoc-field:focus,
.reply-input-wrapper[data-v-03d9f711] .superdoc-field:active {
  border: none;
  box-shadow: none;
  outline: none;
}
.reply-input-wrapper[data-v-03d9f711] .sd-editor-placeholder::before {
  content: 'Reply or add others with @';
}
.reply-actions[data-v-03d9f711] {
  display: flex;
...
.reply-btn-cancel[data-v-03d9f711] {
  background: none;
  border: none;
  font-size: 13px;
  font-weight: 500;
...
.reply-btn-cancel[data-v-03d9f711]:hover {
  color: var(--sd-ui-text, #212121);
}
.reply-btn-primary[data-v-03d9f711] {
...
.reply-btn-primary[data-v-03d9f711]:hover {
  background: var(--sd-ui-action-hover, #0f44cc);
}
.reply-btn-primary.sd-is-disabled[data-v-03d9f711] {
  background: var(--sd-color-gray-400, #dbdbdb);
  color: var(--sd-color-gray-600, #888888);
  cursor: default;
  pointer-events: none;
}
.existing-internal-input[data-v-03d9f711] {
  margin-bottom: 10px;
}
...
.superdoc[data-v-c041a1db] {
  display: flex;
  position: relative;
}
.right-sidebar[data-v-c041a1db] {
  min-width: 320px;
  height: 100%;
}
.floating-comments[data-v-c041a1db] {
  min-width: 300px;
  width: 300px;
  height: 100%;
  overflow: visible;
}
.superdoc__layers[data-v-c041a1db] {
  height: 100%;
  position: relative;
  box-sizing: border-box;
}
.superdoc__document[data-v-c041a1db] {
  width: 100%;
  position: relative;
}
.superdoc__sub-document[data-v-c041a1db] {
  width: 100%;
  position: relative;
}
.superdoc__selection-layer[data-v-c041a1db] {
  position: absolute;
  min-width: 100%;
  min-height: 100%;
  z-index: 10;
...
.superdoc__whiteboard-layer[data-v-c041a1db] {
  z-index: 4;
}
.superdoc__temp-selection[data-v-c041a1db] {
  position: absolute;
}
.superdoc__right-sidebar[data-v-c041a1db] {
  width: 320px;
  min-width: 320px;
  padding: 0 10px;
  min-height: 100%;
...
.superdoc__compact-comment-popover[data-v-c041a1db] {
  position: absolute;
  top: 12px;
  right: 12px;
  z-index: 11;
...
.tools-item i[data-v-c041a1db] {
  cursor: pointer;
}
.superdoc__tools-icon[data-v-c041a1db] {
...
.superdoc .superdoc__layers[data-v-c041a1db] {
    margin: 0;
    border: 0 !important;
    box-shadow: none;
}
...
/* AI Writer styles */
.ai-writer-container[data-v-c041a1db] {
  position: fixed;
  z-index: 1000;
  background: white;
  border-radius: 8px;
...
.ai-tool > svg[data-v-c041a1db] {
  fill: transparent;
}
.ai-tool[data-v-c041a1db]::before {
  content: '';
  position: absolute;
  width: 20px;
  height: 20px;
...
.ai-tool[data-v-c041a1db]:hover::before {
...
.toolbar-dropdown[data-v-764d5fd7] {
  display: inline-flex;
}
.toolbar-dropdown-trigger[data-v-764d5fd7] {
  display: inline-flex;
}
.toolbar-dropdown-menu[data-v-764d5fd7] {
  min-width: 80px;
  padding: 4px;
  border-radius: var(--sd-ui-radius, 6px);
...
.toolbar-dropdown-menu.toolbar-dropdown-menu--render-only[data-v-764d5fd7] {
  padding: 0;
}
.toolbar-dropdown-option[data-v-764d5fd7] {
  min-height: 34px;
  display: flex;
  align-items: center;
  padding: 0 10px;
...
.toolbar-dropdown-option__icon[data-v-764d5fd7] {
  display: inline-flex;
  align-items: center;
  justify-content: center;
  width: 14px;
...
.toolbar-dropdown-option__icon[data-v-764d5fd7] .dropdown-select-icon {
  display: flex;
  width: 12px;
  height: 12px;
}
.toolbar-dropdown-option[data-v-764d5fd7]:hover {
  background: var(--sd-ui-dropdown-hover-bg, #d8dee5);
  color: var(--sd-ui-dropdown-hover-text, #47484a);
}
.toolbar-dropdown-option.sd-selected[data-v-764d5fd7] {
  background: var(--sd-ui-dropdown-active-bg, #d8dee5);
  color: var(--sd-ui-dropdown-selected-text, #47484a);
}
.toolbar-dropdown-menu.high-contrast .toolbar-dropdown-option[data-v-764d5fd7]:not(.sd-render):hover {
  background: #000;
  color: #fff;
}
.toolbar-dropdown-menu.high-contrast .toolbar-dropdown-option:not(.sd-render).sd-selected[data-v-764d5fd7] {
  background: #000;
  color: #fff;
}
.toolbar-dropdown-option.sd-disabled[data-v-764d5fd7] {
  opacity: 0.5;
  cursor: not-allowed;
}
.toolbar-dropdown-option.sd-render[data-v-764d5fd7] {
  padding: 0;
  cursor: default;
  background: transparent;
  color: inherit;
}
.toolbar-dropdown-option.sd-render[data-v-764d5fd7]:hover,
.toolbar-dropdown-option.sd-render.sd-selected[data-v-764d5fd7] {
  background: transparent;
  color: inherit;
}
.fade-in-scale-up-transition-enter-active[data-v-764d5fd7],
.fade-in-scale-up-transition-leave-active[data-v-764d5fd7] {
...
.fade-in-scale-up-transition-enter-from[data-v-764d5fd7],
.fade-in-scale-up-transition-leave-to[data-v-764d5fd7] {
  opacity: 0;
  transform: scale(0.9);
}
.fade-in-scale-up-transition-leave-from[data-v-764d5fd7],
.fade-in-scale-up-transition-enter-to[data-v-764d5fd7] {
  opacity: 1;
  transform: scale(1);
}

.superdoc-toolbar-overflow[data-v-5f8ee279] {
  min-width: auto !important;
  max-width: 200px;
  flex-wrap: wrap;
}

.sd-font-combobox[data-v-53e0af20] {
  display: inline-flex;
  align-items: center;
  height: var(--sd-ui-toolbar-height, 32px);
  max-height: var(--sd-ui-toolbar-height, 32px);
...
.sd-font-combobox[data-v-53e0af20]:focus-within {
  background-color: var(--sd-ui-toolbar-button-active-bg, var(--sd-ui-active-bg, #c8d0d8));
}
.sd-font-combobox.high-contrast[data-v-53e0af20]:focus-within {
  background-color: #000;
  color: #fff;
}
.sd-font-combobox.sd-disabled[data-v-53e0af20] {
  cursor: default;
  opacity: 0.35;
}
.sd-font-combobox__field[data-v-53e0af20] {
  flex: 1 1 auto;
  min-width: 0;
}
.sd-font-combobox__input[data-v-53e0af20] {
  width: 100%;
  min-width: 0;
  height: 100%;
  padding: 0 4px 0 8px;
...
.sd-font-combobox__legacy-label[data-v-53e0af20] {
  position: absolute;
  width: 1px;
  height: 1px;
  overflow: hidden;
...
.sd-font-combobox__caret[data-v-53e0af20] {
  flex-shrink: 0;
  margin: 0;
  border: none;
  background: transparent;
...
.sd-font-combobox.sd-disabled .sd-font-combobox__caret[data-v-53e0af20] {
  cursor: default;
}
.sd-dropdown-caret[data-v-53e0af20] {
  display: inline-flex;
  align-items: center;
  justify-content: center;
  width: 10px;
...
.sd-font-combobox__listbox[data-v-53e0af20] {
  min-width: 80px;
  padding: 4px;
  border-radius: var(--sd-ui-radius, 6px);
  background: var(--sd-ui-dropdown-bg, #fff);
...
.sd-font-combobox__option[data-v-53e0af20] {
  min-height: 34px;
  display: flex;
  align-items: center;
  padding: 0 10px;
...
.sd-font-combobox__option.sd-active[data-v-53e0af20],
.sd-font-combobox__option[data-v-53e0af20]:hover {
  background: var(--sd-ui-dropdown-hover-bg, #d8dee5);
  color: var(--sd-ui-dropdown-hover-text, #47484a);
}
.sd-font-combobox__option.sd-selected[data-v-53e0af20] {
  background: var(--sd-ui-dropdown-active-bg, #d8dee5);
  color: var(--sd-ui-dropdown-selected-text, #47484a);
}
.sd-font-combobox__listbox.high-contrast .sd-font-combobox__option.sd-active[data-v-53e0af20],
.sd-font-combobox__listbox.high-contrast .sd-font-combobox__option[data-v-53e0af20]:hover,
.sd-font-combobox__listbox.high-contrast .sd-font-combobox__option.sd-selected[data-v-53e0af20] {
  background: #000;
  color: #fff;
}

.sd-tooltip-trigger[data-v-88d296cd] {
  display: inline-flex;
}
.sd-tooltip-content[data-v-88d296cd] {
...
.sd-tooltip-arrow[data-v-88d296cd] {
  position: absolute;
  left: 50%;
  bottom: -5px;
  width: 10px;
...
.sd-tooltip-content[data-placement='bottom'] .sd-tooltip-arrow[data-v-88d296cd] {
  bottom: auto;
  top: -5px;
}
...
.fade-in-scale-up-transition-enter-from[data-v-88d296cd],
.fade-in-scale-up-transition-leave-to[data-v-88d296cd] {
  opacity: 0;
  transform: scale(0.9);
}
.fade-in-scale-up-transition-leave-from[data-v-88d296cd],
.fade-in-scale-up-transition-enter-to[data-v-88d296cd] {
  opacity: 1;
  transform: scale(1);
}

.button-group[data-v-8d7a9de1] {
  display: flex;
}

.superdoc-toolbar[data-v-ed19716b] {
  display: flex;
  width: 100%;
  justify-content: space-between;
...
.style-name[data-v-74c8924b] {
  padding: 16px 10px;
  color: var(--sd-ui-dropdown-text, #47484a);
}
.style-name[data-v-74c8924b]:hover {
  background-color: var(--sd-ui-dropdown-hover-bg, #d8dee5);
  color: var(--sd-ui-dropdown-hover-text, #47484a);
}
.linked-style-buttons[data-v-74c8924b] {
  display: flex;
  flex-direction: column;
  width: 100%;
  box-sizing: border-box;
