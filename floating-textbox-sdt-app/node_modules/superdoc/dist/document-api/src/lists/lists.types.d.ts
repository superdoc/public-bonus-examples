import { AffectedRefRemapping, BlockNodeType, ReceiptFailure, ReceiptInsert, StoryLocator, TextAddress, TextRangeShift } from '../types/index.js';
...
export type ListPresetId = 'decimal' | 'decimalParenthesis' | 'lowerLetter' | 'lowerLetterParenthesis' | 'upperLetter' | 'upperLetterParenthesis' | 'lowerRoman' | 'upperRoman' | 'disc' | 'circle' | 'square' | 'dash';
export declare const LIST_KINDS: readonly ["ordered", "bullet"];
export declare const LIST_INSERT_POSITIONS: readonly ["before", "after"];
export declare const JOIN_DIRECTIONS: readonly ["withPrevious", "withNext"];
export declare const MUTATION_SCOPES: readonly ["definition", "instance"];
export declare const LEVEL_ALIGNMENTS: readonly ["left", "center", "right"];
export declare const TRAILING_CHARACTERS: readonly ["tab", "space", "nothing"];
export declare const LIST_PRESET_IDS: readonly ["decimal", "decimalParenthesis", "lowerLetter", "lowerLetterParenthesis", "upperLetter", "upperLetterParenthesis", "lowerRoman", "upperRoman", "disc", "circle", "square", "dash"];
/**
...
export declare const LIST_PRESET_MARKERS: Record<ListPresetId, ListPresetMarker>;
export type ListsFailureCode = 'NO_OP' | 'INVALID_TARGET' | 'INCOMPATIBLE_DEFINITIONS' | 'NO_COMPATIBLE_PREVIOUS' | 'ALREADY_CONTINUOUS' | 'NO_PREVIOUS_LIST' | 'NO_ADJACENT_SEQUENCE' | 'ALREADY_SAME_SEQUENCE' | 'LEVEL_OUT_OF_RANGE' | 'LEVEL_NOT_FOUND' | 'CAPABILITY_UNAVAILABLE' | 'INVALID_INPUT';
