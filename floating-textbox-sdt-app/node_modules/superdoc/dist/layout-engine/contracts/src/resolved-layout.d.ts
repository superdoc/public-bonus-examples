import { ColumnLayout, ColumnRegion, DocumentBackground, DrawingBlock, FlowMode, Fragment, ImageBlock, ImageFragmentMetadata, Line, ListBlock, ListMeasure, PageMargins, PageNumberChapterSeparator, PageNumberFormat, ParagraphBlock, ParagraphBorders, ParagraphMeasure, SectionVerticalAlign, MarkerTrackedChange, SourceAnchor, TableBlock, TableMeasure } from './index.js';
...
export type ResolvedPaintItem = ResolvedGroupItem | ResolvedFragmentItem | ResolvedTableItem | ResolvedImageItem | ResolvedDrawingItem;
...
export declare function isResolvedTableItem(item: ResolvedPaintItem): item is ResolvedTableItem;
/** Type guard: checks whether a resolved paint item is a ResolvedImageItem. */
export declare function isResolvedImageItem(item: ResolvedPaintItem): item is ResolvedImageItem;
/** Type guard: checks whether a resolved paint item is a ResolvedDrawingItem. */
export declare function isResolvedDrawingItem(item: ResolvedPaintItem): item is ResolvedDrawingItem;
