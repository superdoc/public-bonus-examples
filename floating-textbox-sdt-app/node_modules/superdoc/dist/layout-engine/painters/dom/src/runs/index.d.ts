...
export { resolveTrackedChangesConfig, applyTrackedChangeDecorations, applyRowTrackedChangeToCell, } from './tracked-changes.js';
export { resolveRunSdtId, createInlineSdtWrapper, syncInlineSdtWrapperTypography, expandSdtWrapperPmRange, } from '../sdt/inline.js';
