...
export declare const Konva: {
    ...
    Util: {
        ...
        _getPointsRect(points: ArrayLike<number>): import("./types.ts").IRect;
    ...
    DD: {
        ...
        _dragElements: Map<number, {
            ...
            pointerId?: number;
            lastPos?: import("./types.ts").Vector2d;
            startEvent?: any;
            dragStatus: "ready" | "dragging" | "stopped";
        }>;
        _listenToWindow(win: Window): void;
        _batchEvents(callback: () => void, win?: Window): void;
...
export declare namespace Konva {
    ...
    type IRect = import('./types.ts').IRect;
    type GetSet<Type, This> = import('./types.ts').GetSet<Type, This>;
    type Filter = import('./Node.ts').Filter;
    type LineCap = import('./Shape.ts').LineCap;
    type LineJoin = import('./Shape.ts').LineJoin;
