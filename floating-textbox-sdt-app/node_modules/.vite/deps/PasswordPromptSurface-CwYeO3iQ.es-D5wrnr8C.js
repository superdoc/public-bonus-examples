import { B as withDirectives, J as ref, c as withModifiers, d as computed, f as createBaseVNode, h as createElementBlock, j as openBlock, m as createCommentVNode, o as vModelText, rt as toDisplayString, s as withKeys } from "./vue.runtime.esm-bundler-CT2zzfwS.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-BOaGB7Aw.es-BUmYWQ8q.js";
//#region node_modules/superdoc/dist/chunks/PasswordPromptSurface-CwYeO3iQ.es.js
...
var PasswordPromptSurface_default = /*#__PURE__*/ _plugin_vue_export_helper_default({
	...
	setup(__props) {
		...
		const heading = computed(() => isInvalid.value ? props.passwordPrompt.texts.invalidTitle : props.passwordPrompt.texts.title);
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				}, toDisplayString(heading.value), 9, _hoisted_2),
				createBaseVNode("p", _hoisted_3, toDisplayString(__props.passwordPrompt.texts.description), 1),
				...
				}, null, 8, _hoisted_5), [[vModelText, password.value]])]),
				errorMessage.value ? (openBlock(), createElementBlock("p", _hoisted_6, toDisplayString(errorMessage.value), 1)) : createCommentVNode("", true),
				createBaseVNode("div", _hoisted_7, [createBaseVNode("button", {
					type: "button",
					class: "sd-password-prompt__btn sd-password-prompt__btn--cancel",
					disabled: isBusy.value,
					onClick: handleCancel
				}, toDisplayString(__props.passwordPrompt.texts.cancelLabel), 9, _hoisted_8), createBaseVNode("button", {
					type: "button",
					class: "sd-password-prompt__btn sd-password-prompt__btn--submit",
					disabled: !canSubmit.value,
					onClick: handleSubmit
				}, toDisplayString(isBusy.value ? __props.passwordPrompt.texts.busyLabel : __props.passwordPrompt.texts.submitLabel), 9, _hoisted_9)])
			], 40, _hoisted_1);
		};
	}
