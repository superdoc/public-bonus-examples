import { A as onMounted, G as markRaw, J as ref, M as renderList, O as onBeforeUnmount, R as watch, T as mergeProps, Y as shallowRef, d as computed, f as createBaseVNode, h as createElementBlock, j as openBlock, l as Fragment, m as createCommentVNode, nt as normalizeStyle, p as createBlock, v as createVNode } from "./vue.runtime.esm-bundler-CT2zzfwS.js";
import { t as _plugin_vue_export_helper_default } from "./_plugin-vue_export-helper-BOaGB7Aw.es-BUmYWQ8q.js";
import { t as PDF_TO_CSS_UNITS } from "./constants-B6VBlmKp.es-DUDCzKQm.js";
//#region node_modules/superdoc/dist/chunks/PdfViewer-D8h7LRZy.es.js
	...
	setup(__props, { emit: __emit }) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				onMouseup: onMouseUp
			}, [createBaseVNode("div", _hoisted_2, [createBaseVNode("canvas", mergeProps({ class: "sd-pdf-viewer-page__canvas" }, canvasAttrs.value, {
				ref_key: "canvasRef",
				ref: canvasRef
	...
	setup(__props, { expose: __expose, emit: __emit }) {
		...
		return (_ctx, _cache) => {
			return openBlock(), createElementBlock("div", {
				...
				ref_key: "rootRef",
				ref: rootRef
			}, [createBaseVNode("div", _hoisted_1, [createVNode(PdfViewerDocument_default, mergeProps({
				pdf: pdf.value,
				pages: pages.value,
				scale: scale.value,
				config: __props.config,
